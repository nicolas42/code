...
// Draw a black and white mandelbrot_with_void_pointer_argument image in file mandelbrot_with_void_pointer_argument.ppm
// usage: mandelbrot_with_void_pointer_argument(pixel_width, pixel_height, xcenter, ycenter, width, height);
...
// void* mandelbrot_with_void_pointer_argument(void* arg);
// void mandelbrot_usage(void);
// int mandelbrot_main(int argc, char** argv);

// void mandelbrot_usage(void){
// 	printf("mandelbrot_with_void_pointer_argument [pixel_width] [pixel_height]\r\n");
// }
...
//     int arg_shift = 1;
//     // the usage went from 
//     // mandelbrot_with_void_pointer_argument [arguments]
//     // generic-binary mandelbrot_with_void_pointer_argument [arguments]
...
// 	case 1:
// 		mandelbrot_usage(); 
//         printf("Making 1000x1000 mandelbrot_with_void_pointer_argument image...\r\n");
// 		break;
// 	case 3:
// 		pixel_width = atoi(argv[ 1 + arg_shift ]); 
// 		pixel_height = atoi(argv[ 2 + arg_shift ]);
//         printf("Making %dx%d mandelbrot_with_void_pointer_argument image...\r\n", pixel_width, pixel_height);		
// 		break;
// 	case 6:
// 		pixel_width = atoi(argv[ 1 + arg_shift ]); 
// 		pixel_height = atoi(argv[ 2 + arg_shift ]);
...
//         printf("Making %dx%d pixel mandelbrot_with_void_pointer_argument image at %.2fx%.2f with size %.2fx%.2f...\r\n", pixel_width, pixel_height, xcenter, ycenter, width, height);		
// 		break;
// 	case 7:
// 		pixel_width = atoi(argv[ 1 + arg_shift ]); 
// 		pixel_height = atoi(argv[ 2 + arg_shift ]);
...
//     mandelbrot_with_void_pointer_argument(&a);
    ...
    double ycenter, double width, double height)
{
    ...
    // to see full image: mandelbrot_simple(1000,1000,0,0,4,4);
    ...
    // Open file and write header
	char* filename = "mandelbrot_simple.ppm";
	FILE *fp = fopen(filename, "wb"); /* b - binary mode */
	(void) fprintf(fp, "P6\n%d %d\n255\n", pixel_width, pixel_height);
