...
int main(int argc, char ** argv)
{
    int w, h, c;
    int channels = 4;
    unsigned char *stbi_loaded_image = stbi_load("texture.png", &w, &h, &c, channels);
    ...
    // for (int i=0; i<w*h*c; i++) pixels[i] = stbi_loaded_image[i];
    draw_mandelbrot_in_black_and_white(w,h,c, &pixels);
